...
export default function Footer() {
  return (
    <footer className="bg-[#080a14] border-t border-indigo-500/20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-gray-500 text-sm ml-2">A PeeTeeAI Product</span>
              </div>
            </div>
            <p className="text-gray-500 text-sm">&copy; 2026 PeeTeeAI. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
