...
const games = [
  ...
  { name: 'Dual-Code Trainer', slug: 'dual-code', category: 'visual-memory', gameType: 'dual_code', difficulty: 'intermediate', gridSize: 0, timeLimit: 120, maxLevel: 10, description: 'Train visual-verbal binding based on Paivio dual coding theory', benefits: ['Strengthens visual-verbal connections', 'Improves encoding depth', 'Enhances long-term retention'], rules: ['Study emoji-word pairs', 'Recall words from emojis and emojis from words', 'Faster answers earn bonus points'], sortOrder: 13 },
  { name: 'UFOV Speed Trainer', slug: 'ufov-speed', category: 'processing-speed', gameType: 'ufov', difficulty: 'advanced', gridSize: 0, timeLimit: 90, maxLevel: 10, description: 'Based on the ACTIVE Study task that showed 29% dementia risk reduction', benefits: ['Expands useful field of view', 'Improves processing speed', 'Trains divided attention'], rules: ['Identify the center shape', 'Locate the peripheral target', 'Display time gets shorter each round'], sortOrder: 14 },
  { name: 'Spaced Review', slug: 'spaced-review', category: 'verbal-memory', gameType: 'spaced_review', difficulty: 'intermediate', gridSize: 0, timeLimit: 120, maxLevel: 10, description: 'Leitner box system within a session — items you know move ahead, items you miss come back', benefits: ['Optimizes retention intervals', 'Strengthens long-term memory', 'Identifies weak spots'], rules: ['Answer correctly to advance items', 'Wrong answers send items back', 'Higher boxes = more points'], sortOrder: 15 },
]
